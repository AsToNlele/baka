	...
	return (
		<div className="flex flex-col gap-8 pt-8 justify-start">
			<div className="flex gap-8">
				<Avatar className="w-24 h-24" src="https://i.pravatar.cc/150?u=a04258114e29026702d" />
			...
			<Input
				...
				className="max-w-xs"
			/>
			<form onSubmit={handleSubmit(onSubmit)} className="flex gap-8 flex-col items-start">
