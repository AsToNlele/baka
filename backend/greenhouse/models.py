...
class Greenhouse(models.Model):
    ...
    owner = models.ForeignKey(Profile, models.DO_NOTHING, blank=False, null=False, related_name="owner")
    ...
    caretaker = models.ForeignKey(Profile, models.DO_NOTHING, blank=True, null=True, related_name="caretaker")
